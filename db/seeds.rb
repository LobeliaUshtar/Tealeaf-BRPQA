...
Video.create!(title: 'Monk3', description: 'Adrian Monk is a brilliant San Francisco detective, whose obsessive compulsive disorder just happens to get in the way.', small_cover: '/tmp/monk.jpg', large_cover: '/tmp/monk_large.jpg', category_id: 1)
